...
A component to render circles for the nodes:
...
And a component to render text for the labels:
...
Finally, we’ll write one more component to encapuslate all the components with the specified dimensions: 
