...
set of all integers includes 1 and -117. Sets can be finite (there are only so many countries), or infinite (there are infinitely many of numbers). Each object in a set is called a _member_ of that set.
