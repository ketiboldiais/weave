...
:::definition
__Displacement.__ Where ${m}$ is an object, the displacement of ${m}$ is the change in the position of ${m.}$ That is,

$$
	\Delta x \equiv x_f - x_i,
$$

where ${x_f}$ is the final position of ${m}$ and ${x_i}$ is the initial position of ${m.}$
:::

:::definition
__Distance.__ Suppose a mass ${m}$ travels from position ${x_i}$ to position ${x_f.}$ The _length_ of the path that ${m}$ takes from ${x_i}$ to ${x_f}$ is called the _distance_ that ${m}$ travels from ${x_i}$ to ${x_f.}$
:::

Note the distinction between displacement and distance. If a mass ${m}$ travels in one full circle, then the displacement is ${0,}$ since it ends where it started: ${x_i = x_f.}$ The distance traveled, however, is ${2 \pi r.}$