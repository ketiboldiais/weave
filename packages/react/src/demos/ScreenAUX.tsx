...
>(({
  ...
  const getAllIndices = (arr: string, val: string): Array<number> => {
    const indices = [];
    let i = -1;
  ...
  const findRange = (arr: Array<number>, min: number): number => {
